...
- **Automated Heartbeats**: Monitor multiple Render servers simultaneously.
...
```env
RENDER_URL=https://app1.onrender.com, https://app2.onrender.com
QSTASH_TOKEN=your_upstash_token
CRON_SECRET=your_secure_password
```

### 3. Deploy
Push your code to GitHub and connect it to your hosting provider. Ensure you add the environment variables above in your hosting provider's dashboard.
